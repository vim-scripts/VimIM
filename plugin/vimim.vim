...
"            * Support "PinYin", "WuBi", "CangJie", "FourCorner"
...
"            (2) (in Vim Command-line Mode, type:)  :source %
...
" ---------------------------------
    ...
    if s:vimim_static_input_style > 0
        ...
        \ <C-R>=g:vimim_smart_space_dynamic()<CR>
...
" vim:ft=vim:notx:ts=4:fdm=manual
" ====================================== }}}
